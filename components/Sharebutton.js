...
export default function Share_drop_down() {
    ...
    function copy() {
      ...
      useEffect(() => {
        // Set the share URL after the component mounts
        setShareUrl(window.location.href);
    }, []);
    const facebookShareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`;
    const twitterShareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent("Check out this link!")}`;
