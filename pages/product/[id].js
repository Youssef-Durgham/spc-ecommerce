...
function Product({api2}) {
    ...
    const handleClickpc = (e, color) => {
        const colorDiv = e.currentTarget.lastElementChild?.firstElementChild;
        const priceDiv = e.currentTarget.lastElementChild?.lastElementChild;
        console.log("Selected color:", color);
        if (colorDiv && priceDiv) {
          setStylepc(colorDiv.innerHTML);
          setPricepc(priceDiv.innerHTML);
  ...
  {['Black', 'White', 'Yellow', 'Pink', 'Brown', 'Blue', 'Dark', 'Silver'].map((color, index) => {
    console.log(color, selectedColor, selectedColor === color); // Debugging
    return (
        <div 
        key={index} 
        onClick={(e) => handleClickpc(e, color)} 
        className={`border-2 ${selectedColor === color ? 'border-blue-500' : 'border-gray-200'} rounded-lg p-2 shadow hover:shadow-lg transition duration-200 ease-in-out w-28 h-24 flex flex-col items-center justify-between cursor-pointer bg-white`}
      >
        <Image className='w-16 h-16 object-contain' alt={`${color} color`} src={api2.image} height={100} width={100} />
        <div className='text-sm font-semibold text-gray-700'>{color}</div>
        <div className='text-xs text-gray-500'>${api2.price}</div>
      </div>
    );
})}
        ...
        <div className='mt-5 border-4 h-[35vh]'>
            ...
            <Carousel className='z-35' responsive={responsive}>
                ...
                <div className='w-screen  object-scale-down h-[30vh]'>
                    <Image className='w-screen  object-scale-down h-[30vh]' alt={api2.id} src={api2.image} width={100} height={100}></Image>
                </div>
                {/* <div className='w-screen  object-scale-down h-[30vh]'>
                    <Image className='w-screen object-scale-down h-[30vh]' src={api2.data.attributes.image2} width={100} height={100}></Image>
                </div>
                <div className='w-screen  object-scale-down h-[30vh]'>
                    <Image className='w-screen  object-scale-down h-[30vh]' src={api2.data.attributes.image3} width={100} height={100}></Image>
                </div>
                <div className='w-screen  object-scale-down h-[30vh]'>
                    <Image className='w-screen  object-scale-down h-[30vh]' src={api2.data.attributes.image4} width={100} height={100}></Image>
                </div>
                <div className='w-screen  object-scale-down h-[30vh]'>
                    <Image className='w-screen  object-scale-down h-[30vh]' src={api2.data.attributes.image5} width={100} height={100}></Image>
                </div> */}
            </Carousel>
            </div>
            </div>
